...
public class TestSketch extends AbstractSketch {
    ...
    @Override
    public void setup() {
        bg = loadImage("so_good.png");
    }
}
public class SecondSketch extends AbstractSketch {

    public SecondSketch(final PApplet parent, final int width, final int height) {
        super(parent, width, height);
    }
